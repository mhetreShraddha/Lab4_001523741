 ...
 * @author mhetr
 */
public class PatientHis extends javax.swing.JPanel {

    /**
     * Creates new form PatientHistory
     */
    City city;
    public PatientHis(City city) {
        this.city = city;
        initComponents();
        populateTable();
    }
    ...
    private void initComponents() {
        ...
        tblDetail.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient", "Age", "Address 1", "Address 2", "Pincode", "Community", "City"
            }
        ) {
        ...
        tblPatientHistory.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Doctor", "Date", "Blood Pressure rate", "Pluse Rate", "Temperature", "Respiration Rate"
            }
        ) {
            boolean[] canEdit = new boolean [] {
